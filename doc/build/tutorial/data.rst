...
.. seealso::
    ...
    :class:`_sql.Update` - API documentation for UPDATE

    :class:`_sql.Delete` - API documentation for DELETE

    :ref:`bulk_update_delete` - describes ORM use of :class:`_sql.Update`
    and :class:`_sql.Delete`.
